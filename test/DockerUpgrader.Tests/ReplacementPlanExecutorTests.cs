...
namespace DockerUpgrader.Tests
{
    public class ReplacementPlanExecutorTests
    {
        ...
        {
            var stream = typeof(ReplacementPlanExecutorTests).Assembly.GetManifestResourceStream("DockerUpgrader.Tests.Files.Dockerfile")!;
            ...
            var expectedStream = typeof(ReplacementPlanExecutorTests).Assembly.GetManifestResourceStream("DockerUpgrader.Tests.Files.Dockerfile_expected")!;
