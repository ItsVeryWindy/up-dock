...
namespace DockerUpgradeTool
{
    public static class LoggerExtensions
    {
        ...
        public static void LogStartedProcessingRepository(this ILogger logger, Octokit.Repository repository) => _startedProcessingRepository(logger, repository.FullName, null!);
        public static void LogFinishedProcessingRepository(this ILogger logger, Octokit.Repository repository) => _finishedProcessingRepository(logger, repository.FullName, null!);
        public static void LogNoChangesInRepository(this ILogger logger, Octokit.Repository repository) => _noChanges(logger, repository.FullName, null!);
        public static void LogChangesDetectedInRepository(this ILogger logger, Octokit.Repository repository) => _changesDetected(logger, repository.FullName, null!);
    }
}
