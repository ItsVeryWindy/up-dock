...
namespace UpDock
{
    public static class LoggerExtensions
    {
        ...
        public static void LogStartedProcessingRepository(this ILogger logger, IRepository repository) => _startedProcessingRepository(logger, repository.FullName, null!);
        public static void LogSkippedProcessingRepository(this ILogger logger, IRepository repository) => _skippedProcessingRepository(logger, repository.FullName, null!);
        public static void LogFinishedProcessingRepository(this ILogger logger, IRepository repository) => _finishedProcessingRepository(logger, repository.FullName, null!);
        public static void LogNoChangesInRepository(this ILogger logger, IRepository repository) => _noChanges(logger, repository.FullName, null!);
        public static void LogChangesDetectedInRepository(this ILogger logger, IRepository repository) => _changesDetected(logger, repository.FullName, null!);
    }
}
